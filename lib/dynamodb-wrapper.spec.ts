...
describe('lib/dynamodb-wrapper', () => {
  ...
  [
    ...
    it(
      'should pass ' + method + '() calls straight through to the AWS SDK',
      async () => {
        let params: any = {
          TableName: 'Test',
        };
  ...
  describe('putItem()', () => {
    ...
    it('should emit a "consumedCapacity" event when a response contains a ConsumedCapacity object', async () => {
      ...
      dynamoDBWrapper.events.on(
        'consumedCapacity',
        function onConsumedCapacity(e) {
          event = e;
        }
      );
  ...
  describe('batchWriteItem()', () => {
    ...
    function _setupBatchWriteItemParams(
      opts?: ISetupOpts
    ...
    it('should throw a NotYetImplemented exception for item collection metrics', async () => {
      ...
      expect(exception.message).toBe(
        'ReturnItemCollectionMetrics is supported in the AWS DynamoDB API, ' +
