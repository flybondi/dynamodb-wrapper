...
export class MockDynamoDB {
        ...
        return new Promise((resolve, reject) => {
          ...
          if (this._isThroughputExceeded()) {
            ...
            if (this._isSomeUnprocessedItems()) {
              ...
              response["UnprocessedItems"][firstTableName] =
                response["UnprocessedItems"][firstTableName].slice(1);
            } else {
  ...
  private _isThroughputExceeded() {
    return (
      this._customResponses[this._countRequests] ===
      "ProvisionedThroughputExceededException"
    );
  }
  ...
  private _isSomeUnprocessedItems() {
    return (
      this._customResponses[this._countRequests] === "SomeUnprocessedItems"
    );
  }
